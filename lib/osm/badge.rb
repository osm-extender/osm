module OSM
  class Badge < OSM::Model
    ...
    def self.module_completion_data(api:, badge:, no_read_cache: false)
      ...
      fail ArgumentError, "That badge doesn't exist (bad ID #{badge.id})." if data.nil?
      ...
      fail ArgumentError, "That badge doesn't exist (bad version #{badge.version} of #{badge.id})." if data.nil?
